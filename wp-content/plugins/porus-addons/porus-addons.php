<?php
/**
 *    Plugin Name: Porus Addons
 *    Plugin URI: http://g5plus.net
 *    Description: Addons For Porus Theme
 *    Version: 1.0.1
 *    Author: G5
 *    Author URI: http://g5plus.net
 *
 *    Text Domain: porus-addons
...
if (!class_exists('G5ThemeAddons')) {
	class G5ThemeAddons {
        ...
        public function admin_notices() {
            ?>
            <div class="error">
                <p><?php esc_html_e('Porus Addons is enabled but not effective. It requires G5 Core in order to work.','porus-addons'); ?></p>
            </div>
            <?php
        }
		...
		public function load_text_domain() {
			load_plugin_textdomain( 'porus-addons', false, $this->plugin_dir('languages'));
		}
        ...
        /**
         * @return G5ThemeAddons_Shop
         */
		public function shop() {
		    return G5ThemeAddons_Shop::getInstance();
        }
