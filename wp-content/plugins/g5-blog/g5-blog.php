    ...
    class G5BLOG {
        ...
        public function get_plugin_template($slug, $args = array()) {
            ...
            if (!file_exists($located)) {
                _doing_it_wrong(__FUNCTION__, sprintf('<code>%s</code> does not exist.', $slug), '1.0.6');
        ...
        public function locate_template($template_name, $args = array()) {
            ...
            if (!file_exists($located)) {
                _doing_it_wrong(__FUNCTION__, sprintf('<code>%s</code> does not exist.', $located), '1.0.6');
                return '';
            }
        ...
        public function plugin_ver() {
	        ...
	        $plugin_ver = isset($plugin_data['Version']) ? $plugin_data['Version'] : '1.0.6';
