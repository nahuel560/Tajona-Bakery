    ...
    class G5SHOP {
        ...
        public function get_plugin_template($slug, $args = array()) {
            ...
            if (!file_exists($located)) {
                _doing_it_wrong(__FUNCTION__, sprintf('<code>%s</code> does not exist.', $slug), '1.1.0');
        ...
        public function locate_template($template_name, $args = array()) {
            ...
            if (!file_exists($located)) {
                _doing_it_wrong(__FUNCTION__, sprintf('<code>%s</code> does not exist.', $located), '1.1.0');
                return '';
            }
