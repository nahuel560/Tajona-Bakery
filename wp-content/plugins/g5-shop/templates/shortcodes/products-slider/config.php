...
return array(
    ...
    'name' => esc_html__('Products Slider', 'g5-shop'),
    'description' => esc_html__( 'Display slider of products', 'g5-shop' ),
    'category' => G5ELEMENT()->shortcode()->get_category_name(),
    'icon'        => 'g5element-vc-icon-product-slider',
    'params' => array_merge(
        array(
            array(
            ...
            array(
                'type'        => 'textfield',
                'heading'     => __( 'Append Categories', 'g5-shop' ),
