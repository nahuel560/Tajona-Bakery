 ...
 */
return array(
    'base' => 'g5element_product_slider_tabs',
    'name' => esc_html__('Product Slider Tabs', 'g5-shop'),
    'description' => esc_html__( 'Display slider of products tab', 'g5-shop' ),
    'category' => G5ELEMENT()->shortcode()->get_category_name(),
    'icon'        => 'g5element-vc-icon-product-slider-tabs',
    'params' => array_merge(
        array(
            array(
                'type'       => 'param_group',
                'heading'    => esc_html__('Product Slider Tabs', 'g5-shop'),
                'param_name' => 'tabs',
        ...
        g5element_vc_map_add_slider(array(), esc_html__('Slider Options', 'g5-shop')),
        array(
            array(
